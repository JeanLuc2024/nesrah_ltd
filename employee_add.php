                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="first_name" id="first_name"
                                                   ...
                                                   placeholder="Enter first name" value="<?php echo isset($_POST['first_name']) ? $_POST['first_name'] : ''; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="text" name="last_name" id="last_name"
                                                   class="form-control" required minlength="2" maxlength="50"
                                                   placeholder="Enter last name" value="<?php echo isset($_POST['last_name']) ? $_POST['last_name'] : ''; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="email" name="email" id="email"
                                                   ...
                                                   placeholder="Enter email address" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-3">
                                            ...
                                            <input type="tel" name="phone" id="phone"
                                                   ...
                                                   placeholder="Enter phone number" value="<?php echo isset($_POST['phone']) ? $_POST['phone'] : ''; ?>">
                                            <div class="invalid-feedback">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group mb-3">
                                            ...
                                            <textarea name="address" id="address"
                                                      ...
                                                      placeholder="Enter full address (optional)"><?php echo isset($_POST['address']) ? $_POST['address'] : ''; ?></textarea>
...
document.getElementById('addEmployeeForm').addEventListener('submit', function(e) {
    ...
    submitBtn.innerHTML = '<i class="fa fa-spinner fa-spin me-2"></i>Adding Employee...';
