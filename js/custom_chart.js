...
$(function () {
    ...
    if (lineChart) {
        new Chart(lineChart.getContext("2d"), getChartJs('line'));
    }
    
    var barChart = document.getElementById("bar_chart");
    if (barChart) {
        new Chart(barChart.getContext("2d"), getChartJs('bar'));
    }
    
    var radarChart = document.getElementById("radar_chart");
    if (radarChart) {
        new Chart(radarChart.getContext("2d"), getChartJs('radar'));
    }
    
    var pieChart = document.getElementById("pie_chart");
    if (pieChart) {
        new Chart(pieChart.getContext("2d"), getChartJs('pie'));
    }
});
